...
function productlightbox() {
    ...
    function template() {
        return [
            ...
            '.galleryImages .active .product-image-large {display:block !important;max-width:100%;position:relative;top:0;}', // removed max-height:100%
            '</style>',
            '<div class="panel-body">',
            '<ul class="galleryImages">',
            '<li ng-repeat="image in LineItem.images">',
            '<a ng-click="openLightboxModal($index)" ng-class="{active: $index==$parent.index}">', // removed hidden-xs from a class
